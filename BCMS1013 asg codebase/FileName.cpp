...
//		
//		viewServices(numberofServices, P_numberedlist, services_available);
//		cout << "Pick one services (1 - " << *P_numberedlist - 1 << ") : " 
//			<< "\n------------------------------\n";		
//		cout << endl;
//		
//		choice = getInput(P_numberedlist);
...
//	*P_numberedlist = 32;
//	cout << "Pick the day you'd like to book (1 - " << *P_numberedlist - 1 << ") : ";
//	*choice = getInput(P_numberedlist);
//	cout << "\nTimeslots available at " << *choice;
//	*P_numberedlist = 1;
//	for (int i = 0; i < *numberofTimeSlots; ++i)
//	{
//		cout << *P_numberedlist << ". " << fixed << setprecision(2) 
//			<< hourly_timeSlots[i].hours_start << "--" << hourly_timeSlots[i].hours_end << endl;
//		++*P_numberedlist;
//	}
//	cout << "Pick your time slots for the day (1 - " << *P_numberedlist << ") : ";
//	cout << endl;
//	*choice = getInput(P_numberedlist);
//	*P_numberedlist = 1;
